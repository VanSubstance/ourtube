...
public class BasicController {
	...
	public void patchChannelByCtgr(String ctgr) {
		System.out.println("\tYoutube API -> 상위 채널 id 리스트");
		...
		System.out.println("\tDatebase -> 금일 통계 정보 갱신을 위한 채널 id 리스트");
	...
	public void patchVideoByCtgr(String ctgr) {
		System.out.println("\tDatebase -> 채널 id 리스트");
		...
		System.out.println("\tDatabase -> 금일 통계 정보 갱신을 위한 비디오 id 리스트");
