...
public class StatisticsController {
	...
	public List<GameStatistic> getAllGames() {
		...
		System.out.println(" -- 게임 금일 기본 정보 반환 -- " + requestedTime);
		List<GameStatistic> result = new ArrayList<GameStatistic>();
		List<String> titles = serviceBasic.getAllTitle();
		for (String title: titles) {
			result.add(serviceStatistic.getGameStatisticsByGame(title));
		}
		return result;
	}
